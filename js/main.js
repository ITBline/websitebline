...
(function ($) {
    ...
    $(".logo__carousel").owlCarousel({
        loop: true,        // Loop agar terus berputar
        margin: 80,        // Jarak antar item
        items: 12,         // Total item yang bisa tampil
        dots: false,       // Hilangkan navigasi titik
        nav: false,        // Hilangkan tombol navigasi
        smartSpeed: 500,   // Kecepatan transisi (ms) 
        autoHeight: false, // Jangan sesuaikan tinggi otomatis
        autoplay: true,    // Aktifkan autoplay
        autoplayTimeout: 1000, // Waktu antar slide (ms), default 3 detik
